...
description: "All 98 frozen MicroPython modules in the v5.0.2 image, with inferred roles."
---
...
| Module | Role |
| --- | --- |
| `espnow.py` | ESP-NOW wrapper |
| `espnow_conn_v2.py` | connection/session layer |
| `espnow_msg.py` | message model (`cat_id`/`cmd_id`, `TOTEM_MSG_MAP`) |
...
`webrepl.py`, `webrepl_setup.py`, `neopixel.py`.
